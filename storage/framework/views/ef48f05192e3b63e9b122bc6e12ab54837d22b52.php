  ...
  <nav>
    ...
    <center>
    	<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	        <div class='p2'>
	        	<div>
	        	<img src="<?php echo e($order->image); ?>" height='200px' width='200px'>
	        	</div>
	        	<div>
	        		<b><font size='15px'><?php echo e($order->item_name); ?></font></b>
              		<br><br>
              		<b>Price:			</b><?php echo e($order->amount); ?>

              		<br><br>
              		<b>Quantity:			</b><?php echo e($order->Qty); ?>

              		<br><br>
              		<b>Notes:			</b><?php echo e($order->remarks); ?>
	    ...
	    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<center>
				<b>Delivery Address:			</b><?php echo e($order->delivery_address); ?>
...
</html><?php /**PATH C:\Users\Prayag\Desktop\project5\resources\views/order.blade.php ENDPATH**/ ?>