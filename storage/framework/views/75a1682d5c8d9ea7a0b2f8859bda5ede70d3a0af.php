    ...
    <center> 
            ...
            <?php $__currentLoopData = $hamburgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hamburgers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <form action="/info" method="post">
                <?php echo csrf_field(); ?>
                <input type='hidden' name='burger_name' value="<?php echo e($hamburgers->ham_name); ?>">
                <img src="<?php echo e($hamburgers->ham_image); ?>" height='150px' width='150px'>
                <figcaption>
                  <span><?php echo e($hamburgers->ham_name); ?></span><br>
                  <span>$ <?php echo e($hamburgers->price); ?></span><br>
...
</html><?php /**PATH C:\Users\Prayag\Desktop\project5\resources\views/Menu.blade.php ENDPATH**/ ?>