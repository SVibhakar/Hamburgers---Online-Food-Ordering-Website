...
<body bgcolor="black" text="white">
  <nav>
    ...
    <br><br>
      <center>
        <?php $__currentLoopData = $hamburgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hamburgers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <form method='post' action="/place_order" id='myForm'>
            ...
            ?>
            <input type='hidden' name='name' value="<?php echo e($hamburgers->ham_name); ?>">
            <input type='hidden' name='image' value="<?php echo e($hamburgers->ham_image); ?>">
            <br>
            <img src="<?php echo e($hamburgers->ham_image); ?>" height='250px' width='250px'>
            <br>
            <b><font size='15px'>"<?php echo e($hamburgers->ham_name); ?>"</font></b>
            <br><br>
            <b>Ingredients:     </b><?php echo e($hamburgers->ingredients); ?>

            <br><br>
            <b>Calories:      </b><?php echo e($hamburgers->calories); ?> cal
            <br><br>
            <b>Price:     </b>$<?php echo e($hamburgers->price); ?>
...
</html><?php /**PATH C:\Users\Prayag\Desktop\project5\resources\views/info.blade.php ENDPATH**/ ?>